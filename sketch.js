...
function preload(){
  ...
  shooterImg = loadImage("assets/h1.png")
  shooter_shooting = loadImage("assets/h2.png")

  zombieImg = loadImage("assets/dementor1.png")

  bgImg = loadImage("assets/forest.webp")
siriusImg = loadImage("assets/sb1.png")
...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   sirius = createSprite(displayWidth-1350, displayHeight-500, 50, 50);
...
if(zombieGroup.isTouching(player)||zombieGroup.isTouching(sirius)){
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(600,1500),random(100,500),40,40)
